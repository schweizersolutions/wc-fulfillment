...
/**
 * WCFF_Interface_ShortcodeHook is used by an object that needs to subscribe to
 * WordPress shortcode hooks.
 */
interface WCFF_Interface_ShortcodeHook {
	/**
	 * Returns an array of shortcodes that the object needs to be subscribed to.
	 *
